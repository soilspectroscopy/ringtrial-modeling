...
if(!dir.exists(paste0(mnt.dir, "pca"))){dir.create(paste0(mnt.dir, "pca"))}
...
if(!dir.exists(paste0(mnt.dir, "predictions/CT-KSSL_Cubist"))){dir.create(paste0(mnt.dir, "predictions/CT-KSSL_Cubist"))}
